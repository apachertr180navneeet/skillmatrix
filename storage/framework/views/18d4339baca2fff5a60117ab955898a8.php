    ...
    <div class="authentication-inner py-4">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('super.admin.forget.password.post')); ?>" method="POST" class="mb-3">
                    <?php echo csrf_field(); ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('super.admin.login')); ?>" class="d-flex align-items-center justify-content-center">
...
<?php echo $__env->make('super_admin.layouts.login_layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/super_admin/auth/forgot-password.blade.php ENDPATH**/ ?>