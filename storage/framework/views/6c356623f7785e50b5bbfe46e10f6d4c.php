...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <!-- ================= SUGGESTED SOP ================= -->
    <h5 class="mb-3">Checklists SOP</h5>
                    ...
                    <a href="<?php echo e($checklistsuggestion->file); ?>" target="_blank"
                       style="text-decoration:none;color:inherit;">
                        ...
                        <div class="sop-actions">
                            <!-- EDIT -->
                            <a href="<?php echo e(route('admin.sop.edit', $checklistsuggestion->id)); ?>"
                            class="btn btn-warning text-white">
                                Edit
                            </a>

                            <!-- DELETE -->
                            <form action="<?php echo e(route('admin.sop.destroy', $checklistsuggestion->id)); ?>"
                                method="POST"
            ...
            <div class="col-md-3">
                <div class="sop-card">
                    ...
                    <div class="sop-actions">
                        ...
                        <!-- ADD Q&A -->
                        <a href="<?php echo e(route('admin.sop.qa.create', $checklist->id)); ?>"
                           class="btn btn-danger">
                            Add Q&A
                        </a>

                        <!-- EDIT -->
                        <a href="<?php echo e(route('admin.sop.edit', $checklist->id)); ?>"
                           class="btn btn-warning text-white">
                            Edit
                        </a>

                        <!-- DELETE -->
                        <form action="<?php echo e(route('admin.sop.destroy', $checklist->id)); ?>"
                              method="POST"
                              onsubmit="return confirm('Are you sure you want to delete this SOP?')">
                            <?php echo csrf_field(); ?>
                            <?php echo method_field('DELETE'); ?>
