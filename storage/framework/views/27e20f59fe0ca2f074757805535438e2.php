...
$(document).ready(function () {
    ...
    $('#AddDepartment').click(function () {
        ...
        $.ajax({
            url: "<?php echo e(route('super.admin.departments.store')); ?>",
            type: "POST",
            data: {
    ...
    $('#UpdateDepartment').click(function () {
        ...
        $.ajax({
            url: "<?php echo e(route('super.admin.departments.update')); ?>",
            type: "POST",
            data: {
                _token: "<?php echo e(csrf_token()); ?>",
                id: $('#edit_id').val(),
    ...
    $(document).on('change', '.changeStatus', function () {
        $.post("<?php echo e(route('super.admin.departments.status')); ?>", {
            _token: "<?php echo e(csrf_token()); ?>",
            id: $(this).data('id'),
    ...
    window.deleteDepartment = function (id) {
        if (confirm('Are you sure?')) {
            $.ajax({
                url: "<?php echo e(url('master/departments/delete')); ?>/" + id,
                method: "DELETE",
    ...
    window.editDepartment = function (id) {
        $.get("<?php echo e(url('master/departments/get')); ?>/" + id, function (data) {
            $('#edit_id').val(data.id);
...
<?php echo $__env->make('super_admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_project\skillmatrixl10\resources\views/super_admin/department/index.blade.php ENDPATH**/ ?>