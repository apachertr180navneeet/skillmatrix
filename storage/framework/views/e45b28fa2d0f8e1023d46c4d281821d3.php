    ...
    <div class="row g-4">
        ...
        <?php $__empty_1 = true; $__currentLoopData = $sops; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sop): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                <a href="<?php echo e($sop->sop_upload); ?>" target="_blank" class="text-decoration-none text-dark">
                    <div class="sop-card">
...
<?php echo $__env->make('web.userlayouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\skillmatrixl10\resources\views/web/sop/index.blade.php ENDPATH**/ ?>