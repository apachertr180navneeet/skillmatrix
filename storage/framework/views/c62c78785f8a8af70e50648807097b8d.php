...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="row mb-3">
        <div class="col-md-12">
            <h5>
                <span class="text-primary fw-light">Checklist</span> Q&A
            </h5>
        </div>
    </div>
        ...
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <div class="sop-title-box">
                    <?php echo e($checklist->title ?? 'N/A'); ?>
            ...
            <div class="total-question">
                Total <?php echo e($checklistQuesAns->count()); ?> questions
            </div>

            <!-- Questions & Options -->
            <?php $__empty_1 = true; $__currentLoopData = $checklistQuesAns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="mt-4">
...
<?php echo $__env->make('super_admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/super_admin/checklist/showqa.blade.php ENDPATH**/ ?>