...
$(function(){
    ...
    window.editUser=function(id){
        ...
        $.get("<?php echo e(url('super-admin/user/get')); ?>/"+id,function(d){
            $("#editid").val(d.id);
    ...
    window.deleteUser=function(id){
        if(confirm("Are you sure?")){
            $.ajax({
                url:"<?php echo e(url('super-admin/user/delete')); ?>/"+id,
                method:"DELETE",
...
<?php echo $__env->make('super_admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/super_admin/user/index.blade.php ENDPATH**/ ?>