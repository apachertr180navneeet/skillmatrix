                        ...
                        <div class="button">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <li>
                                        <a class="dropdown-item" href="<?php echo e(route('company.login')); ?>">
                                            🏢 Company Login
                                        </a>
                                    </li>
                                </ul>
...
<!-- End Header Area --><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/web/layouts/elements/header.blade.php ENDPATH**/ ?>