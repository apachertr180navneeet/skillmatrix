                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $videoUserResults; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="<?php echo e(route('admin.video.result.view', $row->id)); ?>"
                                   class="btn btn-view">
                                    View
                                </a>
                            </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_project\skillmatrixl10\resources\views/admin/video_results/index.blade.php ENDPATH**/ ?>