            ...
            <form>
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="text"
                               class="form-control"
                               value="<?php echo e($checklist->department_names ?? '-'); ?>"
                               readonly>
                    </div>
...
<?php echo $__env->make('super_admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/super_admin/checklist/show.blade.php ENDPATH**/ ?>