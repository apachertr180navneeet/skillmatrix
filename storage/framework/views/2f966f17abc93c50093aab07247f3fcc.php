...
<?php $__env->startSection('content'); ?>
    <div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="form-card">
            ...
            <form action="<?php echo e(route('company.sop.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" placeholder="SOP title">
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($department->id); ?>"
                                <?php echo e(collect(old('department_id'))->contains($department->id) ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>" placeholder="Enter SOP description"><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/admin/sop/create.blade.php ENDPATH**/ ?>