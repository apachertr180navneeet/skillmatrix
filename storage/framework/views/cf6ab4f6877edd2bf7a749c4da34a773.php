                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select id="company_id" class="form-control">
                            ...
                            <?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($c->id); ?>"><?php echo e($c->copmany_name); ?></option>
...
$(function(){
    ...
    const table = $('#userTable').DataTable({
        processing: true,
        ajax: "<?php echo e(route('super.admin.user.getall')); ?>",
        columns: [
            { data: 'full_name' },
            { data: 'email' },
            { data: 'phone' },
    ...
    $("#AddUser").click(function(){
        ...
        $.ajax({
            url:"<?php echo e(route('super.admin.user.store')); ?>",
            method:"POST",
            data:form,
            contentType:false,
            processData:false,
    ...
    window.editUser=function(id){
        ...
        $.get("<?php echo e(url('master/user/get')); ?>/"+id,function(d){
            $("#editid").val(d.id);
    ...
    $("#UpdateUser").click(function(){
        ...
        $.ajax({
            url:"<?php echo e(route('super.admin.user.update')); ?>",
            method:"POST",
            data:form,
            contentType:false,
            processData:false,
    ...
    window.deleteUser=function(id){
        if(confirm("Are you sure?")){
            $.ajax({
                url:"<?php echo e(url('master/user/delete')); ?>/"+id,
                method:"DELETE",
    ...
    $(document).on("change",".toggleStatus",function(){
        ...
        $.post({
            url:"<?php echo e(route('super.admin.user.status')); ?>",
            data:{_token:"<?php echo e(csrf_token()); ?>",userId:id,status:status},
...
<?php echo $__env->make('super_admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_project\skillmatrixl10\resources\views/super_admin/user/index.blade.php ENDPATH**/ ?>