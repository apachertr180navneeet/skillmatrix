...
<div class="container-fluid container-p-y">
    ...
    <div class="form-card">
        <form action="<?php echo e(route('admin.video.update', $video->id)); ?>"
              method="POST"
...
unset($__errorArgs, $__bag); ?>">
                    ...
                    <?php $__currentLoopData = $departments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($department->id); ?>"
                            <?php echo e(old('department_id', $video->department_id) == $department->id ? 'selected' : ''); ?>>
                ...
                <div class="radio-group">
                    <label>
                        <input type="radio" name="is_link" value="yes"
                            <?php echo e(old('is_link', $video->is_link) === 'yes' ? 'checked' : ''); ?>>
                        Video Link
                    </label>

                    <label>
                        <input type="radio" name="is_link" value="no"
                            <?php echo e(old('is_link', $video->is_link) === 'no' ? 'checked' : ''); ?>>
                        Upload Video
                    </label>
                </div>
            </div>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-4">
                ...
                <textarea name="description" rows="4"
                          class="form-control"><?php echo e(old('description', $video->description)); ?></textarea>
            </div>
                ...
                <div class="radio-group">
                    <label>
                        <input type="radio" name="is_suggestion" value="1"
                            <?php echo e(old('is_suggestion', $video->is_suggestion) == 1 ? 'checked' : ''); ?>>
                        Yes
                    </label>

                    <label>
                        <input type="radio" name="is_suggestion" value="0"
                            <?php echo e(old('is_suggestion', $video->is_suggestion) == 0 ? 'checked' : ''); ?>>
                        No
                    </label>
                </div>
            </div>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel_project\skillmatrixl10\resources\views/admin/video/edit.blade.php ENDPATH**/ ?>