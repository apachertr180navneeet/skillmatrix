...
$(document).ready(function () {
    ...
    window.editCompany = function (id) {
        $.get("<?php echo e(url('super-admin/company/get')); ?>/" + id, function (data) {
    ...
    window.deleteCompany = function (id) {
        if (confirm('Are you sure?')) {
            $.ajax({
                url: "<?php echo e(url('super-admin/company/delete')); ?>/" + id,
                method: "DELETE",
...
<?php echo $__env->make('super_admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/super_admin/company/index.blade.php ENDPATH**/ ?>