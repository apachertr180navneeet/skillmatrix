...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="top-actions">
            <a href="<?php echo e(route('company.checklist.create')); ?>" class="btn btn-primary">
                + Create
            </a>
        </div>
            ...
            <table class="table align-middle">
                ...
                <tbody id="checklistTableBody">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($checklist->department_names ?? '-'); ?>

                        </td>

                        <td>
                            <a href="<?php echo e(route('company.checklist.view', Crypt::encryptString($checklist->id))); ?>"
                        ...
                        <td>
                            ...
                            <div class="action-btns">
                                ...
                                <a href="<?php echo e(route('company.checklist.qa.create', $checklist->id)); ?>"
                                    class="btn btn-qa btn-sm">
                                    Q&A
                                </a>

                                <a href="<?php echo e(route('company.checklist.edit', $checklist->id)); ?>"
                                    class="btn btn-edit btn-sm">
                                    Edit
                                </a>

                                <form action="<?php echo e(route('company.checklist.destroy', $checklist->id)); ?>" method="POST"
    ...
    $(document).ready(function() {
            ...
            function loadChecklists() {
                ...
                $.ajax({
                    ...
                    url: "<?php echo e(route('company.checklist.filter')); ?>",
                    type: "GET",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/admin/checklist/index.blade.php ENDPATH**/ ?>