    ...
    <div class="qa-card">
        ...
        <div class="mb-3">
            ...
            <div class="checklist-title-box">
                <?php echo e($checklistDetails->title); ?>
        ...
        <!-- QUESTIONS FORM -->
        <form action="<?php echo e(route('user.checklist.qa.submit')); ?>" method="POST">
            <?php echo csrf_field(); ?>

            <input type="hidden" name="checklist_id" value="<?php echo e($checklistDetails->id); ?>">

            <?php $__currentLoopData = $checklistQuesAns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $qa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('web.userlayouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/web/checklist/qa.blade.php ENDPATH**/ ?>