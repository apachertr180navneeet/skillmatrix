...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="form-card">
        ...
        <form action="<?php echo e(route('company.checklist.store')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/admin/checklist/create.blade.php ENDPATH**/ ?>