	...
	<div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
		...
		<div class="navbar-nav align-items-center">
			<div class="nav-item d-flex align-items-center text-primary">
				...
				<span class=""><?php echo e(date('D')); ?> <?php echo e(date('d M Y')); ?></span>
			</div>
		</div>
		<!-- /Search -->
		...
		<ul class="navbar-nav flex-row align-items-center ms-auto">
			...
			<li class="nav-item navbar-dropdown dropdown-user dropdown">
				...
				<ul class="dropdown-menu dropdown-menu-end">
					<li>
						<a class="dropdown-item" href="<?php echo e(route('super.admin.profile')); ?>">
							<div class="d-flex">
					...
					<li>
						<a class="dropdown-item" href="<?php echo e(route('super.admin.change.password')); ?>">
					...
					<li>
						<a class="dropdown-item" href="<?php echo e(route('super.admin.logout')); ?>">
...
</nav><?php /**PATH C:\xampp\htdocs\laravel_project\skillmatrixl10\resources\views/super_admin/layouts/elements/header.blade.php ENDPATH**/ ?>