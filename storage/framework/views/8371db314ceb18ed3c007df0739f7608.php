    ...
    <script>
        $(document).ready(function() {
            ...
            const table = $('#userTable').DataTable({
                ajax: "<?php echo e(route('company.user.getall')); ?>",
                columns: [{
                        data: 'id',
            ...
            function loadDepartments(select) {
                $.get("<?php echo e(route('company.departments.getall')); ?>", res => {
            ...
            $('#AddUser').click(function() {
                clearErrors();
                $.post("<?php echo e(route('company.user.store')); ?>", {
            ...
            window.editUser = function(id) {
                $.get("<?php echo e(url('company/users/get')); ?>/" + id, data => {
                    $('#editid').val(data.id);
            ...
            $('#EditUser').click(function() {
                clearErrors();
                $.post("<?php echo e(route('company.user.update')); ?>", {
                    _token: "<?php echo e(csrf_token()); ?>",
                    id: $('#editid').val(),
                    name: $('#edit_name').val(),
            ...
            window.deleteUser = function(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('company/users/delete')); ?>/" + id,
                            method: "DELETE",
                            data: {
                                _token: "<?php echo e(csrf_token()); ?>"
                            },
            ...
            $(document).on('change', '.changeStatus', function() {
                ...
                $.post("<?php echo e(route('company.user.status')); ?>", {
                    _token: "<?php echo e(csrf_token()); ?>",
                    userId: $(this).data('id'),
            ...
            $('#bulkDelete').click(function() {
                ...
                $.post("<?php echo e(route('company.user.bulkDelete')); ?>", {
                    _token: "<?php echo e(csrf_token()); ?>",
                    ids: ids
                }, function(res) {
                    if (res.success) {
            ...
            function bulkStatus(status) {
                ...
                $.post("<?php echo e(route('company.user.bulkStatus')); ?>", {
                    _token: "<?php echo e(csrf_token()); ?>",
                    ids: ids,
                    status: status
                }, function(res) {
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/admin/user/index.blade.php ENDPATH**/ ?>