...
<div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="summary-body">
            <div class="info-grid">
                <div class="info-item">
                    ...
                    <span class="info-value"><?php echo e($result->sop->title ?? '-'); ?></span>
                </div>
    ...
    <div class="result-actions">
        <a href="<?php echo e(route('company.sop.result.index')); ?>" class="btn btn-secondary">
            Back to Results
        </a>
    </div>
...
<?php echo $__env->make('web.userlayouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/web/sop_results/view.blade.php ENDPATH**/ ?>