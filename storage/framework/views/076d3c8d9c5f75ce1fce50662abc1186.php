...
$(document).ready(function () {
    ...
    window.editUser = function(id){
        $.get("<?php echo e(url('admin/users/get')); ?>/"+id, function(data){
            $('#editid').val(data.id);
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\skillmatrixl10\resources\views/admin/user/index.blade.php ENDPATH**/ ?>