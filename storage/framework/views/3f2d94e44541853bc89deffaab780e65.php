...
<div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="summary-grid">
            <div class="summary-column">
                <div class="summary-item">
                    ...
                    <div class="summary-value"><?php echo e($result->video->title ?? '-'); ?></div>
                </div>
    ...
    <!-- ================= BACK ================= -->
    <a href="<?php echo e(route('company.video.result.index')); ?>" class="btn btn-secondary mt-3">
        Back to Results
    </a>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/admin/video_results/view.blade.php ENDPATH**/ ?>