...
<div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="summary-grid">
            <div class="summary-column">
                <div class="summary-item">
                    <div class="summary-label">SOP Title</div>
                    <div class="summary-value"><?php echo e($result->sop->title ?? '-'); ?></div>
                </div>
    ...
    <!-- ================= BACK ================= -->
    <a href="<?php echo e(route('company.sop.result.index')); ?>" class="btn btn-secondary mt-3">
        Back to Results
    </a>
