                        ...
                        <div class="row g-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="full_name" class="form-control" placeholder="Enter Full Name" value="<?php echo e(old('full_name', $user->full_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="<?php echo e($user->department->department_name ?? '-'); ?>" readonly>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
...
<?php echo $__env->make('web.userlayouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/apache/htdocs/resources/views/web/auth/profile.blade.php ENDPATH**/ ?>