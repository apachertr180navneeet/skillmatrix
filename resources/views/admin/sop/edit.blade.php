                ...
                <select name="department_id"
                    ...
                    @foreach($departments as $department)
                        <option value="{{ $department->id }}"
                            {{ old('department_id', $sop->department_id) == $department->id ? 'selected' : '' }}>
            ...
            <div class="mb-4">
                ...
                @if($sop->sop_upload)
                    <div class="file-preview">
                        Current file:
                        <a href="{{ $sop->sop_upload }}" target="_blank">View SOP</a>
                    </div>
                @endif
                ...
                <div class="radio-group">
                    <label class="radio-box">
                        <input type="radio"
                               name="is_suggestion"
                               value="1"
                               {{ old('is_suggestion', $sop->is_suggestion) == 1 ? 'checked' : '' }}>
                        Yes
                    </label>
                    ...
                    <label class="radio-box">
                        <input type="radio"
                               name="is_suggestion"
                               value="0"
                               {{ old('is_suggestion', $sop->is_suggestion) == 0 ? 'checked' : '' }}>
                        No
                    </label>
                </div>
                @error('is_suggestion')
