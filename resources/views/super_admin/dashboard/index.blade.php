    ...
    <div class="row g-4 dashboard-grid">
        @foreach ($metrics as $metric)
            <div class="col-xl-4 col-md-6">
                <div
                    class="metric-card"
                    style="--card-accent: {{ $metric['accent'] }}; --card-soft: {{ $metric['soft'] }}; --card-ink: {{ $metric['ink'] }};"
                >
                    <div class="metric-card-head">
                        <span class="metric-icon">
                            <i class="bx {{ $metric['icon'] }}"></i>
                        </span>
                        <span class="metric-tag">{{ $metric['tag'] }}</span>
                    </div>
                    ...
                    <div class="metric-value">
                        ...
                        <span class="metric-caption">{{ $metric['label'] }}</span>
                    </div>

                    @if (!empty($metric['breakdown']))
                        <div class="metric-breakdown">
                            @foreach ($metric['breakdown'] as $item)
                                <div class="metric-breakdown-item">
                                    <span class="metric-breakdown-label">{{ $item['label'] }}</span>
