    ...
    <body>
       <div class="layout-wrapper layout-content-navbar">
            <div class="layout-container">
                @include('web.userlayouts.elements.left_sidebar')
                <div class="layout-page">
                    @include('web.userlayouts.elements.header')
                    <div class="content-wrapper">
                        @yield('content')
                        @include('web.userlayouts.elements.footer')
                        <div class="content-backdrop fade"></div>
                    </div>
                    @include('web.userlayouts.elements.right_sidebar')
                </div>
                ...
                @yield('script')
                @include('web.userlayouts.elements.sweet_alerts')
            </div>
