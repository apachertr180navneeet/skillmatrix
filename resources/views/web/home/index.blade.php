        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 col-12">
                    <div
                        class="hero-image wow fadeInRight"
                        data-wow-delay=".4s"
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                <!-- Single Choose -->
                <div
                    class="single-choose wow fadeInUp"
                    data-wow-delay=".2s"
        ...
        <div class="step-wrapper">
            ...
            <div class="col-lg-6 col-12">
                <div
                    ...
                    style="visibility: hidden; animation-delay: 0.6s; animation-name: none"
                >
                    <img src="{{ asset('assets/web/assets/images/precuresteps.png') }}" alt="#" class="img-fluid" />
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="tns-outer" id="tns1-ow">
                        ...
                        <div id="tns1-mw" class="tns-ovh">
                            <div class="tns-inner" id="tns1-iw">
                                <div
                                    class="testimonial-slider tns-slider tns-carousel tns-subpixel tns-calc tns-horizontal"
                                    id="tns1"
                                    style="transition-duration: 0s; transform: translate3d(-20%, 0px, 0px)"
                                >
                                    <div
                                        class="single-testimonial tns-item tns-slide-cloned"
                                        aria-hidden="true"
                                        tabindex="-1"
                                    >
                                        <div class="top-section">
                                            <img src="{{ asset('assets/web/assets/images/testi3.jpg') }}" alt="#" />
                                            <h3>
                                                Phet Putrie
                                    ...
                                    <div class="single-testimonial tns-item tns-slide-active" id="tns1-item0">
                                        <div class="top-section">
                                            <img src="{{ asset('assets/web/assets/images/testi2.jpg') }}" alt="#" />
                                            <h3>
                                                Aaron Almaraz
                                    ...
                                    <!-- Start Single Testimonial -->
                                    <div
                                        class="single-testimonial tns-item"
                                        id="tns1-item1"
                                        aria-hidden="true"
                                        tabindex="-1"
                                    >
                                        <div class="top-section">
                                            <img src="{{ asset('assets/web/assets/images/testi5.jpg') }}assets/images/testi5.jpg" alt="#" />
                                            <h3>
                                                Marleah Eagleston
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 col-12">
                <!-- Single Table -->
                <div
                    class="single-table wow fadeInUp"
                    data-wow-delay=".2s"
                    style="visibility: hidden; animation-delay: 0.2s; animation-name: none"
                >
                    <!-- Table Head -->
                    <div class="table-head">
                        <div class="price">
                            <p class="amount">₹300.00</p>
                        </div>
                        <div class="title">
                            <h4>For enterprise use</h4>
                        </div>
                    </div>
                    <!-- End Table Head -->
                    <!-- Table List -->
                ...
                <div class="accordion" id="accordionExample">
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingOne">
                            ...
                            >
                                <span>What is the Precure Skill Training System?</span
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingTwo">
                            ...
                            >
                                <span>Who is this training system designed for?</span
                                ><i class="lni lni-chevron-down"></i>
                            </button>
                        </h2>
                        <div
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingThree">
                            ...
                            >
                                <span>How is your training different from traditional training programs?</span
                                ><i class="lni lni-chevron-down"></i>
                            </button>
                        </h2>
                        <div
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="headingFour">
                            ...
                            >
                                <span>How do you measure employee improvement?</span
                                ><i class="lni lni-chevron-down"></i>
                            </button>
                        </h2>
                        <div
        ...
        <div class="row">
            <div class="col-lg-8 offset-lg-2 col-md-12 col-12">
                <div class="inner-content">
                    ...
                    <div
                        class="button style3 wow fadeInUp"
                        data-wow-delay=".6s"
                        style="visibility: hidden; animation-delay: 0.6s; animation-name: none"
                    >
