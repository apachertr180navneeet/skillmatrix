        ...
        <div class="dashboard-stack">
            <div class="dashboard-hero">
                <div class="hero-card">
                    ...
                    <div class="hero-highlights">
                        ...
                        <div class="highlight-tile">
                            ...
                            <strong>{{ $vedioResultTotal }}</strong>
                ...
                <div class="spotlight-card">
                    ...
                    <div class="spotlight-total">{{ $totalTest }}</div>
                    <div class="spotlight-title">Your activity overview</div>
                    <p class="spotlight-copy">
                        You have engaged with {{ $sopResultTotal + $checklistResultTotal + $vedioResultTotal }} tracked review records across the learning workflow.
                    </p>
            ...
            <div class="section-card">
                ...
                <div class="quick-actions">
                    <a href="{{ route('user.sop') }}" class="quick-card">
                    ...
                    <a href="{{ route('user.checklist') }}" class="quick-card">
                    ...
                    <a href="{{ route('user.video') }}" class="quick-card">
            ...
            <div class="section-card">
                <div class="section-head">
                    ...
                    <a href="{{ route('user.sop.results') }}" class="section-link">View results</a>
                </div>
